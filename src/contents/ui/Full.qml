...
Item {
  ...
  Item {
    ...
    // ── Nothing-style dot-matrix music note badge ──────────────────────
    Item {
      id: badge
      x: 10
      y: 10
      ...
      // 8x8 dot matrix grid, centered in the circle
      // 1 = dot visible (gold), 0 = empty
      // Represents a music note (stem right, flag, filled head)
      Grid {
        ...
        property var pattern: [
          // col: 0  1  2  3  4  5  6  7
          /* row 0 */  [0, 0, 0, 0, 0, 1, 1, 0],
          /* row 1 */  [0, 0, 0, 0, 0, 1, 0, 1],
          /* row 2 */  [0, 0, 0, 0, 0, 1, 0, 0],
          /* row 3 */  [0, 0, 0, 0, 0, 1, 0, 0],
          /* row 4 */  [0, 0, 0, 0, 0, 1, 0, 0],
          /* row 5 */  [0, 0, 1, 1, 0, 1, 0, 0],
          /* row 6 */  [0, 1, 1, 1, 1, 1, 0, 0],
        ...
        Repeater {
          ...
          Rectangle {
            ...
            height:  3.2
            radius:  1.6
            color:   parent.pattern[row][col] === 1 ? root.nothingWhite : "#2B2D32"
            opacity: 0.92
          }
        }
      }
